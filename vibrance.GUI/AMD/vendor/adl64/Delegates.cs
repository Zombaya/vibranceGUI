...
namespace gui.app.gpucontroller.amd.adl32
{
    public class Delegates
    {
        ...
        public delegate int ADL_Display_Color_Get(
            int a, int b, int c, ref int d, ref int e, ref int f, ref int g, ref int h);

        public delegate int ADL_Display_Color_Set(int a, int b, int c, int d);

        public delegate int ADL_Display_DisplayInfo_Get(
            int adapterIndex, ref int numDisplays, out IntPtr displayInfoArray, int forceDetect);
