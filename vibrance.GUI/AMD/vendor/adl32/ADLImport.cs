...
namespace gui.app.gpucontroller.amd.adl64
{
    public static class ADLImport
    {
        ...
        public static extern int ADL_Main_Control_Create(Delegates.ADL_Main_Memory_Alloc callback,
        ...
        [DllImport(Atiadl_FileName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ADL_Display_DisplayInfo_Get(int adapterIndex, ref int numDisplays,
            out IntPtr displayInfoArray, int forceDetect);

        [DllImport(Atiadl_FileName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ADL_Display_Color_Set(int a, int b, int c, int d);

        [DllImport(Atiadl_FileName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ADL_Display_Color_Get(int a, int b, int c, ref int d, ref int e, ref int f, ref int g,
            ref int h);
    }
}