...
{
    internal class NvidiaSettingsWrapper
    {
        ...
        {
            var settingsWrapperList = new List<NvidiaSettingsWrapper>();
            ...
            var percentageValue = NVAPI_DEFAULT_LEVEL;
        ...
        public static NvidiaSettingsWrapper find(int value)
        {
            ...
            var returnWrapper = settingsList.Find(x => x.getValue == value);
